...
export class TagsCreateComponent {
	...
	Please review this schema. I will provide you with specific details about the documents I need you to generate in a follow-up message. For now, do not create or suggest any documents; just acknowledge the schema and wait for my next instructions.`;
	close: () => void;
	setTags: () => void;
	entities = '';
	store: string;
